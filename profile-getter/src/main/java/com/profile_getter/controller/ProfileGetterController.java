package com.profile_getter.controller;
...
import com.profile_getter.service.UserProfileService;
...
public class ProfileGetterController {
    ...
    public ResponseEntity<?> getUserProfiles(@RequestBody List<Long> userIds) {
        try {
            ...
            List<UserProfileResponseDTO> profiles = userProfileService.getUserProfilesByIds(userIds);
