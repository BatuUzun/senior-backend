...
public class ReviewCommentController {
	...
	public ResponseEntity<?> getCommentsByReviewId(@PathVariable Long reviewId,
	    ...
	    try {
	        ...
	        // ✅ Convert to DTOs before returning the response
	...
	private ReviewCommentResponseDTO mapToDTO(ReviewComment reviewComment) {
